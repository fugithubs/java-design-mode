 ...
 */
package com.example.javadesignmode.Image;
...
public class CompressPicDemo {
	...
	public static void main(String[] arg) {
		...
		System.out.println("输入的图片大小：" + mypic.getPicSize("D:\\jxsbt\\1 (3).jpg") / 1024
				+ "KB");
		int count = 0; // 记录全部图片压缩所用时间
		for (int i = 0; i < 10; i++) {
			int start = (int) System.currentTimeMillis(); // 开始时间
			mypic.compressPic("D:\\jxsbt\\", "D:\\jxsbt\\test\\", "1 (3).jpg", "r1" + i + ".jpg",
					120, 120, true);
			...
			System.out.println("输出的图片大小："
					+ mypic.getPicSize("D:\\jxsbt\\test\\r1" + i + ".jpg") / 1024
					+ "KB");
		}
