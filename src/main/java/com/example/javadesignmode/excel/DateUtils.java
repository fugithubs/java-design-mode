...
public class DateUtils {
	...
	public static void main(String[] args) throws Exception {
		System.out.println("系统当前日期" + DateUtils.getNowTimestamp());
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
		String format = simpleDateFormat.format(new Date(
				Calendar.getInstance().getTimeInMillis()));
		System.out.println(format);
		Date k = simpleDateFormat.parse("2016-10-21");
		Date j = simpleDateFormat.parse("2017-11-21");
		Date c = simpleDateFormat.parse(format);
		System.out.println(c.getTime()<k.getTime());
		System.out.println(j.getTime()<c.getTime());
	}
