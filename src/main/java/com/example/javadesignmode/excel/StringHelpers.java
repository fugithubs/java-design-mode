 ...
 * <p> Company:KQ GEO Technologies Co., Ltd. </p>
 *
...
public class StringHelpers
{
	...
	public static void main(String[] args) {
		...
		String oldtext = "d";
		int os = s.indexOf(oldtext)+1;
		System.out.println("oldtext site ： "+os);
		if(os==1||(os>1&&os<length)){
			oldtext+=",";
		}else if(os==length){
			oldtext=","+oldtext;
		}
		System.out.println(s.replace(oldtext, ""));
		System.out.println("-------------------------------------");
		String ss="\\2017\\02\\07\\巡护轨迹数据\\5f8b0ad9-f5f4-4ce4-a342-124a8502fd1e.jpg?\\2017\\02\\07\\巡护轨迹数据\\d837c04d-6967-4d27-829d-c7ee1c2f4286.jpeg";
		...
		System.out.println("-----------------------------");
		List<String> cmouths = new ArrayList<String>();
		for(int i=1;i<13;i++){
			if(i<10){
				cmouths.add("0"+i);
			}else {
		...
		String[] array = {"03","04","12"};
		for(String sa : array){
			cmouths.remove(sa);
		}
		for(String i : cmouths){
			System.out.print(i+",");
		}
	}
}
